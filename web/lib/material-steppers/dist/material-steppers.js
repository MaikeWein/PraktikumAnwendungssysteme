...
angular.module('mdSteppers', ['ngMaterial'])
    ...
    .config(['$mdIconProvider', function ($mdIconProvider) {
        $mdIconProvider.icon('heart', 'mdSteppers/ic_check_24px.svg');
